...
class BfInterpreter {
	...
	#updateBlockValue(increase: boolean = true): void {
		if (increase) {
	...
	#updatePointer(increase: boolean = true): void {
		if (increase) {
			this.pointer++;
	...
	#getPositionOfClosingBracket(chars: string[]): number {
